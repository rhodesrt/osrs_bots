...
public final class MotherlodeMine extends AbstractScript {
  ...
  public void onStart() {
    ...
    beginXp = Skills.getExperience(Skill.MINING);
    Logger.log("Motherlode Mine script starting up.");
  }
  ...
  public void onPaint(Graphics g) {
    ...
    g.drawString("Mining: " + Skills.getRealLevel(Skill.MINING), leftX, lowestYText - yStep * 3);
  }
