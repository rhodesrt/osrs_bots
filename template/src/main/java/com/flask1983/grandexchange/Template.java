...
import com.flask1983.grandexchange.nodes.TemplateNode;

@ScriptManifest(name = "Template", description = "Template script.", author = "flask1983", version = 1.0, category = Category.COMBAT, image = "")
public final class Template extends AbstractScript {
  ...
  public void onStart() {
    ...
    Logger.log("Template script starting up.");
  }
