...
import com.flask1983.grandexchange.nodes.FletchingNode;

@ScriptManifest(name = "Fletching", description = "Fletching script.", author = "flask1983", version = 1.0, category = Category.FLETCHING, image = "")
public final class Fletching extends AbstractScript {
  private int MAX_RUN_TIME = 65;
  ...
  public void onStart() {
    ...
    beginXp = Skills.getExperience(Skill.FLETCHING);
    Logger.log("Fletching Script starting up.");
  }
  ...
  public void onPaint(Graphics g) {
    ...
    g.drawString("Fletching: " + Skills.getRealLevel(Skill.FLETCHING), leftX, lowestYText - yStep * 3);
  }
